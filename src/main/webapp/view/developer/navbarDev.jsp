    <header>
      <nav>
        <ul class="list">
          ...
          <!-- DEVELOPER -->
          <li class="dropdown">
            <button class="dropbtn active" disabled>Developer</button>
            <div class="dropdown-content">
